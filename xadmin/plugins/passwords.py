...
class ResetPasswordSendView(BaseAdminView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if 'my_status' in kwargs:
            context['my_status'] = kwargs['my_status']
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            my_status = form.save(**opts)
            if my_status == '数据库查无此邮箱':
                return self.get(request, form=form, my_status=my_status)
            context = super(ResetPasswordSendView, self).get_context()
