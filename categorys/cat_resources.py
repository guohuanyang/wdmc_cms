# -*- coding: utf-8 -*-
from categorys.models import GlassesCat, Color, CurtainCat, CtrDirection
...
class CtrDirectionResource(resources.ModelResource):
    def __init__(self):
        super(CtrDirectionResource, self).__init__()

        field_list = CtrDirection._meta.fields
        self.vname_dict = {}
        for i in field_list:
            self.vname_dict[i.name] = i.verbose_name
    ...
    class Meta:
        ...
        # import_id_fields = ('num', )
        # print(get_all_fields(ALastMonthTest))
        import_id_fields = get_all_fields(CtrDirection)


class GlassesCatResource(resources.ModelResource):
    def __init__(self):
        super(GlassesCatResource, self).__init__()

        field_list = GlassesCat._meta.fields
        self.vname_dict = {}
        for i in field_list:
            self.vname_dict[i.name] = i.verbose_name
    ...
    class Meta:
        ...
        # import_id_fields = ('num', )
        # print(get_all_fields(ALastMonthTest))
        import_id_fields = get_all_fields(GlassesCat)
